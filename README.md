...
## ⚠️ SECURITY NOTICE - OpenAI Agents Removed

**Date:** October 5, 2025

This project previously contained OpenAI-based agentic agents (GPT-5 Code Agent, Code Interpreter, Image Generation Agent, Computer Use Agent). Due to a **critical security incident** where an OpenAI agent deleted ~700GB of user data through unrestricted shell execution, **all OpenAI agentic services have been permanently removed**.

**What was removed:**
- ❌ OpenAI GPT-5 Code Agent
- ❌ OpenAI Code Interpreter Agent
- ❌ OpenAI Image Generation Agent
- ❌ GPT Computer Use Agent 
- ❌ All OpenAI Agents SDK dependencies

**Safe alternatives available:**
- ✅ **Grok Code Agent** (xAI) - Fast, secure agentic coding
- ✅ **Claude Code Agent** (Anthropic) - Professional SDK-based agent

For details on the incident, see `OPENAI_SECURITY_INCIDENT_REPORT.md`.

**We will not use OpenAI's agentic services in this project due to their untrustworthiness and lack of proper security sandboxing.**
...
# With additional compute dependencies
pip install harvester-sdk
```
...
### Agentic Commands (Safe Agents Only)
- `harvester agent-grok` - **Grok Code Agent** - Fast agentic coding (grok-code-fast-1)
- `harvester agent-claude` - **Claude Code Agent** - Professional agentic assistant
