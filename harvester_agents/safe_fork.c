...
static int max_forks_per_second = 50;   // Default: 50 forks/sec (increased for TensorFlow/builds)
static int max_total_forks = 5000;      // Default: 5000 total forks (increased for ML libraries)
